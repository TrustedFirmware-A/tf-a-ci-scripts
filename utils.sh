...
tf_src_repo_url="${tf_src_repo_url:-https://$tforg_gerrit_url/${GERRIT_PROJECT_PREFIX:-}TF-A/trusted-firmware-a}"
tftf_src_repo_url="${tftf_src_repo_url:-$TFTF_SRC_REPO_URL}"
tftf_src_repo_url="${tftf_src_repo_url:-https://$tforg_gerrit_url/${GERRIT_PROJECT_PREFIX:-}TF-A/tf-a-tests}"
ci_src_repo_url="${ci_src_repo_url:-$CI_SRC_REPO_URL}"
ci_src_repo_url="${ci_src_repo_url:-https://$tforg_gerrit_url/${GERRIT_PROJECT_PREFIX:-}ci/tf-a-ci-scripts}"
tf_ci_repo_url="$ci_src_repo_url"
spm_src_repo_url="${spm_src_repo_url:-$SPM_SRC_REPO_URL}"
spm_src_repo_url="${spm_src_repo_url:-https://$tforg_gerrit_url/${GERRIT_PROJECT_PREFIX:-}hafnium/hafnium}"
rmm_src_repo_url="${rmm_src_repo_url:-$RMM_SRC_REPO_URL}"
rmm_src_repo_url="${rmm_src_repo_url:-https://$tforg_gerrit_url/${GERRIT_PROJECT_PREFIX:-}TF-RMM/tf-rmm}"
